...
/**
 * This class contains some predefined examples of {@StarWarsCharacter}.
 *
 */
public class StarWarsCharacterFixtures {
	...
	public static StarWarsCharacter ACKBAR = new StarWarsCharacter("Ackbar", "Mon Calamari", "Mon Cala");
	...
	public static List<StarWarsCharacter> getAsList() {
		List<StarWarsCharacter> values = Arrays.asList(LUKE, HAN, CHEWBACCA, OBIWAN, YODA, LEIA, C3PO, R2D2, LANDO,
				ACKBAR, ANAKIN, QUIGON, PADME, MACE, JARJAR, WATTO, SEBULBA);
