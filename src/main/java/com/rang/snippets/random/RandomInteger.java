...
public class RandomInteger {
    ...
    /**
     * Generates a random integer using integers full range from -2,147,483,648 to +2,147,483,647.
     * 
     * @return random int
     */
    ...
    /**
     * Generates a random integer between 0 (inclusive) and the value of the given parameter (inclusive).
     * 
    ...
    /**
     * Generates a random integer between the values of the two given parameters (inclusive).
     * 
