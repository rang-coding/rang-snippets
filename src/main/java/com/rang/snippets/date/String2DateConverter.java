...
/**
 * This class contains multiple examples of conversions from {@link String} to
 * {@link Date} and java.time-Objects introduced with Java 1.8.
 */
public class String2DateConverter {

	/**
	 * Parses a {@link String} to {@link LocalTime} using
	 * {@link DateTimeFormatter.ISO_LOCAL_TIME} as format-pattern.
	 */
	...
	/**
	 * Parses a {@link String} to {@link LocalDate} using
	 * {@link DateTimeFormatter.ISO_LOCAL_DATE} as format-pattern.
	 */
	...
	/**
	 * Parses a {@link String} to {@link LocalDateTime} using
	 * {@link DateTimeFormatter.ISO_LOCAL_DATE_TIME} as format-pattern.
	 */
	...
	/**
	 * Parses a {@link String} to {@link LocalDateTime} using the given
	 * format-pattern.
	 */
	...
	/**
	 * Parses a {@link String} to {@link ZonedDateTime} using
	 * {@link DateTimeFormatter.ISO_ZONED_DATE_TIME} as format-pattern.
	 */
	...
	/**
	 * Parses a {@link String} to {@link ZonedDateTime} using the given
	 * format-pattern.
	 */
	...
	/**
	 * Parses a {@link String} to {@link LocalTime} using {@code 'yyyy-MM-dd'} as
	 * format-pattern.
	 */
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(
				"MM/dd/yyyy HH:mm:ss z: " + asZonedDateTime("11/17/2019 04:20:17 EST", "MM/dd/yyyy HH:mm:ss z"));
