...
/**
 * This class contains multiple examples of conversions from
 * {@link java.sql.Date} to {@link Date} and java.time-Objects introduced with
 * Java 1.8 and vice versa.
 */
public class SqlDateConverter {

	/**
	 * Converts {@link Date} to {@link java.sql.Date}. All time information will be
	...
	/**
	 * Converts {@link LocalDateTime} to {@link java.sql.Date}. All time information
	...
	/**
	 * Converts {@link java.sql.Date} to {@link Date}. {@link java.sql.Date} does
	 * not contain any time information, so it has to be appended.
	 */
	...
	/**
	 * Converts {@link java.sql.Date} to {@link LocalDateTime}.
	 * {@link java.sql.Date} does not contain any time information, so it has to be
	 * appended.
	 */
