...
/**
 * This class contains multiple examples of conversions from {@link Date} to java.time-Objects introduced with Java 1.8
 * and vice versa.
 */
public class DateConverter {
    ...
    /**
     * Converts {@link Date} to {@link LocalDate}. All time information will be discarded in the process.
     */
    ...
    /**
     * Converts {@link Date} to {@link ZonedDateTime}. {@link Date} does not contain any timezone information, so it has
     * to be appended.
     */
    ...
    /**
     * Converts {@link LocalTime} to {@link Date}. {@link LocalTime} does not contain any date information, so it has to
     * be appended.
     */
    ...
    /**
     * Converts {@link LocalDate} to {@link Date}. {@link LocalDate} does not contain any time information, so it has to
     * be appended.
     */
    ...
    /**
     * Converts {@link ZonedDateTime} to {@link Date}. All timezone information will be discarded in the process.
     */
