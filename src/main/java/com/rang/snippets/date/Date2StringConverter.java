...
/**
 * This class contains multiple examples of conversions from {@link Date} and
 * java.time-Objects introduced with Java 1.8 to {@link String}.
 */
public class Date2StringConverter {
	...
	/**
	 * Converts {@link LocalDateTime} to {@link String} using the given
	 * format-pattern.
	 */
	...
	/**
	 * Converts {@link ZonedDateTime} to {@link String} using the given
	 * format-pattern.
	 */
	...
	/**
	 * Converts {@link java.sql.Date} to {@link String} using format-pattern
	 * 'yyyy-MM-dd'.
	 */
