...
import com.rang.snippets.fixtures.LegoSet;
import com.rang.snippets.fixtures.LegoSetFixtures;

/**
 * This class contains multiple examples of how to form a sum over a specific number-property of an object in a
 * collection.
 *
...
public class PropertySumCalculator {
    ...
    /**
     * Forms the sum over a given {@link Integer}-property of an object in a collection by using a conventional
    ...
    /**
     * Forms the sum over a given {@link Integer}-property of an object in a collection under the usage of streams. Sums
    ...
    /**
     * Forms the sum over a given {@link BigInteger}-property of an object in a collection under the usage of streams.
    ...
    /**
     * Forms the sum over a given {@link BigDecimal}-property of an object in a collection under the usage of streams.
     * Null values within the collection will be ignored.
     * 
     * @param values A collection of objects
