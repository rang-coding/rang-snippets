...
public class ArraySumCalculator {
    ...
    public static void main(String[] args) {
        ...
        // Array of BigInteger
        BigInteger[] bigIntegerValues = {
                BigInteger.valueOf(1), BigInteger.valueOf(1), BigInteger.valueOf(2), BigInteger.valueOf(3),
        ...
        BigDecimal[] bigDecimalValues = {
                BigDecimal.valueOf(1.01), BigDecimal.valueOf(1.01), BigDecimal.valueOf(2.02), BigDecimal.valueOf(3.03),
                BigDecimal.valueOf(5.05), BigDecimal.valueOf(8.08), BigDecimal.valueOf(13.13),
